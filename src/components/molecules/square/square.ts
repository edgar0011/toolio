...
class ContentSquare extends HTMLElement {
  connectedCallback() {
    ...
    this.innerHTML = `
      <div class="rounded-lg flex flex-col justify-start p-[clamp(1.25rem,2.5dvw,2.5rem)] opacity-0 -translate-y-8 transition-all duration-500 ease-out cursor-default bg-t-surface" data-card>
